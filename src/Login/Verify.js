    ...
    return (
      <form className={`Verify-form ${animationClass}`} action="#" autoComplete="off">
        ...
        <div className="button-container">
          <button onClick={this.handleCancel} ref={(el) => this.cancelBtn = el} className="mdc-button cancel">
            Cancel
          </button>
          <button onClick={this.handleVerify} ref={(el) => this.verifyBtn = el} disabled={!verificationCode || !!signingIn} className="mdc-button mdc-button--raised next">
            Verify Code
          </button>
        </div>
      </form>
